...
def plot_bar_1(qoess_baloss, qoess_webrtc, qoess_dash, figname):
    ...
    plt.savefig(figname + "_bar.png", type='png')
    #plt.legend(ncol=3, loc='upper left', bbox_to_anchor=(0.2,1.1), fontsize=asize - 10)
...
if __name__=="__main__":
    ...
    #plot the figure.1 comparing the log with different trace
    plot_bar_1([qoess_withs[0], qoess_withs[1], qoess_withs[2], qoess_withs[0]],[qoess_withouts[0],qoess_withouts[0],qoess_withouts[0],qoess_withouts[0]],[qoess_withouts[0],qoess_withouts[0],qoess_withouts[0],qoess_withouts[0]],"abr_improve_bar")