...
def plot_bar_1(qoess_baloss, qoess_webrtc, qoess_dash, figname):
    ...
    webrtc_pos = np.arange(len(qoess_baloss)) + bar_width
    ...
    rects_balossx = ax.bar(baloss_pos, baloss_qoes,
                           edgecolor='black', color='none', linewidth=lwidth,
                           align='center', width=bar_width)
    # rects_advanced_baloss = ax.bar(advanced_baloss_pos, [0.79,0.79], label='Advanced BaLoss', color='black',
...
if __name__=="__main__":
    ...
    #plot the figure.1 comparing the log with different trace
    plot_bar_1([qoess_withs[0], qoess_withs[1], qoess_withs[2], qoess_withs[0]],[qoess_withouts[0],qoess_withouts[0],qoess_withouts[0],qoess_withouts[0]],[qoess_withouts[0],qoess_withouts[0],qoess_withouts[0],qoess_withouts[0]],"abr_improve_bar_trace3")