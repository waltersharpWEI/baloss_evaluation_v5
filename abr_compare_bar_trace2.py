...
def plot_bar_1(qoess_baloss, qoess_webrtc, qoess_dash, figname):
    ...
    webrtc_qoes = [0.35,0.38]
    dash_qoes = [0.40,0.41]
    baloss_qoes = [0.72,0.75]
...
if __name__=="__main__":
    ...
    #plot the figure.1 comparing the log with different trace
    plot_bar_1([qoess_withs[0], qoess_withs[1], qoess_withs[2], qoess_withs[0]],[qoess_withouts[0],qoess_withouts[0],qoess_withouts[0],qoess_withouts[0]],[qoess_withouts[0],qoess_withouts[0],qoess_withouts[0],qoess_withouts[0]],"abr_improve_bar_trace2")