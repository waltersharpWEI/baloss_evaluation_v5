...
#this code is made for drawing the Fig.4(b) for CoNEXT21'
#which shows the oscilination phenonmenon
#when use ABR with GCC, and the fact that with or without GCC end up with the same
#final QoE level due to the interplace between ABR and GCC bitrate control
#It also shows GCC slows down the downward spiral, which in some cases can avoid the
#bitrate to drop too much in a dynamic enviroment
#The equibilirium point is labeled too.
